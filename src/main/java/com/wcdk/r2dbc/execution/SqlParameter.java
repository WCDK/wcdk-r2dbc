 ...
 */
public record SqlParameter(String name, Object value, Class<?> javaType, Type databaseType) {

    public SqlParameter(Object value, Class<?> javaType, Type databaseType) {
        this(null, value, javaType, databaseType);
    }
    ...
    public static SqlParameter of(Object value) {
        ...
        return new SqlParameter(null, value, value.getClass(), null);
    }

    public static SqlParameter nullOf(Class<?> javaType) {
        return new SqlParameter(null, null, javaType, null);
    }

    public static SqlParameter database(Object value, Class<?> javaType, Type databaseType) {
        return new SqlParameter(null, value, javaType, Objects.requireNonNull(databaseType, "databaseType"));
    }
