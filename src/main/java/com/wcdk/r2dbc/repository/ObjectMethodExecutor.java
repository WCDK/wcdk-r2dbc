...
final class ObjectMethodExecutor implements RepositoryMethodExecutor {
    ...
    private final com.wcdk.r2dbc.repository.metadata.RepositoryMetadata metadata;

    ObjectMethodExecutor(Class<?> repositoryInterface, com.wcdk.r2dbc.repository.metadata.RepositoryMetadata metadata) {
